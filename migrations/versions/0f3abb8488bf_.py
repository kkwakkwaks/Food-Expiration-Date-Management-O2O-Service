...
Revision ID: 0f3abb8488bf
Revises: 8278892db68f
Create Date: 2022-09-09 00:34:15.399283
...
revision = '0f3abb8488bf'
down_revision = '8278892db68f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_unique_constraint(op.f('uq_barcode_b_category_id'), 'barcode', ['b_category_id'])
...
def downgrade():
    ...
    op.drop_constraint(op.f('uq_barcode_b_category_id'), 'barcode', type_='unique')
