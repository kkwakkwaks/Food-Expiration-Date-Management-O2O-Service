...
Revision ID: 545d34ae230e
Revises: 8104e925bab3
Create Date: 2022-09-08 18:23:37.579979
...
revision = '545d34ae230e'
down_revision = '8104e925bab3'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_unique_constraint(op.f('uq_answer_user_id'), 'answer', ['user_id'])
...
def downgrade():
    ...
    op.drop_constraint(op.f('uq_answer_user_id'), 'answer', type_='unique')
