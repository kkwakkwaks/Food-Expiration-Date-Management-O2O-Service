...
Revision ID: cf93301a00d1
Revises: 0249043caed5
Create Date: 2022-09-09 00:08:27.897484
...
revision = 'cf93301a00d1'
down_revision = '0249043caed5'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.alter_column('recipe_ingredient', 'ingredient_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.create_foreign_key(op.f('fk_recipe_ingredient_recipe_id_recipes'), 'recipe_ingredient', 'recipes', ['recipe_id'], ['recipe_id'])
    op.create_foreign_key(op.f('fk_recipe_ingredient_ingredient_id_ingredient'), 'recipe_ingredient', 'ingredient', ['ingredient_id'], ['ingredient_id'])
...
def downgrade():
    ...
    op.alter_column('recipe_situation', 'situation_id',
               ...
               nullable=True,
               autoincrement=True)
    op.drop_constraint(op.f('fk_recipe_ingredient_ingredient_id_ingredient'), 'recipe_ingredient', type_='foreignkey')
    op.drop_constraint(op.f('fk_recipe_ingredient_recipe_id_recipes'), 'recipe_ingredient', type_='foreignkey')
    op.alter_column('recipe_ingredient', 'ingredient_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.alter_column('recipe_ingredient', 'recipe_id',
